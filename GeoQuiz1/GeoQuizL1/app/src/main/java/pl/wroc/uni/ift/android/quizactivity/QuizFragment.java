...
import pl.wroc.uni.ift.android.quizactivity.CheatActivity;
import pl.wroc.uni.ift.android.quizactivity.QuestionBank;
import pl.wroc.uni.ift.android.quizactivity.QuestionListActivity;
import pl.wroc.uni.ift.android.quizactivity.QuizActivity;
import pl.wroc.uni.ift.android.quizactivity.R;
...
public class QuizFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mApiLevel = (TextView) mApiLevel.findViewById(R.id.Level);
        mLevelString = "API Level: "+ Build.VERSION.SDK_INT;
        mApiLevel.setText(mLevelString);

        mTokenTextView = (TextView) mTokenTextView.findViewById(R.id.token_view);
        updateTokens();

        mCheatButton = (Button) mCheatButton.findViewById(R.id.button_cheat);
        mCheatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                boolean currentAnswer = mQuestionsBank.getQuestion(mCurrentIndex).isAnswerTrue();
                Intent intent = CheatActivity.newIntent(getActivity(), currentAnswer);
...
//                intent.putExtra("answer", currentAnswer);
        ...
        mAllQuestionsButton = (Button) mAllQuestionsButton.findViewById(R.id.button_list);
        ...
        mQuestionTextView = (TextView) mQuestionTextView.findViewById(R.id.question_text_view);
        ...
        mFalseButton = (Button) mFalseButton.findViewById(R.id.false_button);
        ...
        mNextButton = (ImageButton) mNextButton.findViewById(R.id.next_button);
        ...
        mPrevButton = (ImageButton) mPrevButton.findViewById(R.id.previous_button);
    ...
    private void updateQuestion() {
        ...
        if (odpowiedziane >= 4){
            if(mIsCheater==false){
                Toast.makeText(getActivity(), "KONIEC", Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(getActivity(), "KONIEC, oszuscie!", Toast.LENGTH_LONG).show();
            }
        }
    }
